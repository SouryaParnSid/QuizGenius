                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border border-slate-600 rounded-lg p-6 bg-slate-800/50">
                        ...
                        <div className="space-y-3">
                          {(() => {
                            const currentQuestionData = generatedQuiz[currentQuestion];
                            const isTrueFalse = currentQuestionData?.type === 'true-false' || 
                                              currentQuestionData?.question?.toLowerCase().includes('true or false');
                            
                            // For True/False questions, provide standard True/False options
                            const options = isTrueFalse ? ['True', 'False'] : (currentQuestionData?.options || []);
                      ...
                      <div className="space-y-4">
                        {generatedQuiz.map((question, index) => {
                          ...
                          const isTrueFalse = question?.type === 'true-false' || 
                                            question?.question?.toLowerCase().includes('true or false');
                            ...
                            <div key={question.id} className={`p-4 rounded-lg border ${
                              ...
                              <div className="text-sm space-y-1">
                                <p className={`${isCorrect ? 'text-green-400' : 'text-red-400'}`}>
                                  Your answer: {options[userAnswer] || 'Not answered'} {isCorrect ? '✓' : '✗'}
                                </p>
                                {!isCorrect && (
                                  <p className="text-green-400">
                                    Correct answer: {options[question.correct_answer] || 'Unknown'}
                                  </p>
                                )}
